...
├── 飞书AI提示词.md                # 建表/AI字段/看板/智能体 提示词合集
├── 答辩口播稿_90秒.md             # 演示口播稿
├── 竞品与行业调研分析.md          # 差异化定位与竞品对比
├── 实施路线图与价值测算.md        # 落地路线图 + 透明价值测算 + 风险
├── 样例_AI周度决策复盘报告.md     # 产出物样例：闭环到效果验证
├── 样例_数据质量体检报告.md       # 产出物样例：数据前置体检 + 健康分
├── 参考资料清单.md                # 引用来源（均经核实）
├── 架构图.png                     # 高清架构图
├── arch.mmd                       # 架构图源文件（Mermaid）
